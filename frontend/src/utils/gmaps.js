const API_KEY = "AIzaSyD3C3y44zQkaTFoaVzuQRW8a2g6-11Q1tI"
...
export default function init() {
  ...
  script.async = true
  script.defer = true
  script.src = `https://maps.googleapis.com/maps/api/js?key=${API_KEY}&v=beta&libraries=marker,places&callback=${CALLBACK_NAME}`
